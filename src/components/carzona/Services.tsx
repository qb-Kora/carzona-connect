...
const Services = () => (
  <section id="uslugi" className="py-20 md:py-32 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
        {services.map((service, i) => (
          <motion.div
            ...
            className="card-hover p-5 md:p-6 rounded-3xl cursor-default group"
          >
            {service.popular && (
            ...
            <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center mb-4 md:mb-5 group-hover:bg-primary/20 transition-colors duration-300">
            ...
            <a
              href="#kontakt"
              className="inline-flex text-sm text-primary font-medium hover:text-accent transition-colors duration-300 touch-target items-center"
            >
              Sprawdź szczegóły →
            </a>
          </motion.div>
